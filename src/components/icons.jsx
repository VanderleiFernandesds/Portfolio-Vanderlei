...
export function TargetArrowIcon({ className = 'h-5 w-5' }) {
  return (
    <svg className={className} {...defaultProps}>
...
export function RocketIcon({ className = 'h-5 w-5' }) {
  return (
    <svg className={className} {...defaultProps}>
      ...
      <path d="M12 15l-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 19 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2" />
